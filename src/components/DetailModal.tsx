...
export default function DetailModal() {
  ...
  const isOpenAiTask = (taskProvider ?? 'kefu-xiang') === 'kefu-xiang'
  ...
  const taskProviderName = taskProvider === 'fal' ? 'fal.ai' : taskProvider ? '客服小祥' : '未知'
                ...
                {task.rawResponsePayload && (
                  <div className="relative group">
                    <button
                      ...
                      className="inline-flex items-center justify-center rounded-full border border-purple-200/80 bg-purple-50 px-3 py-1.5 text-purple-600 transition hover:bg-purple-100 "
                      aria-label="查看原始响应"
                    >
            ...
            <div className="flex items-center gap-1.5 mb-2">
              ...
              {showPromptWarning && (
                <span className="relative inline-flex">
                  <button
                    type="button"
                    className="p-1 rounded text-amber-500 hover:bg-amber-50  transition"
